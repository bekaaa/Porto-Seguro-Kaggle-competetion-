...
params = {
	...
	#------------------------------------------------------------------------------
	'objective': 'reg:logistic',#'binary:logistic', # reg:linear, reg:logistic, binary:logistic, multi:softmax
	'eval_metric' : 'auc', # error for binary class., merror for multiclass classification, "map" Mean Average Precesion.
	'random_seed' : 0,
	'n_jobs' : 4
}
